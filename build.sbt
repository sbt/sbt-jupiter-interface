...
ThisBuild / githubWorkflowBuild := Seq(WorkflowStep.Sbt(
  List("javafmtCheckAll", "test", "scripted"),
  name = Some("Formatting"),
  cond = Some("matrix.java != 'zulu@8'"),
  env = Map("SBT_OPTS" -> "-J--add-exports=jdk.compiler/com.sun.tools.javac.api=ALL-UNNAMED -J--add-exports=jdk.compiler/com.sun.tools.javac.code=ALL-UNNAMED -J--add-exports=jdk.compiler/com.sun.tools.javac.file=ALL-UNNAMED -J--add-exports=jdk.compiler/com.sun.tools.javac.parser=ALL-UNNAMED -J--add-exports=jdk.compiler/com.sun.tools.javac.tree=ALL-UNNAMED -J--add-exports=jdk.compiler/com.sun.tools.javac.util=ALL-UNNAMED"),
))
